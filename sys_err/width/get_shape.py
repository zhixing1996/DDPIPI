...
def main():
    ...
    if mode == 'D1_2420_signal':
        ...
        path_out = '/besfs/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/width/SHAPE_D1_2420_'+str(ecms)+'_signal.root'
        shape_D1_2420_raw(path_in, path_out, ecms, cms, mode, xmin, xmax, xbins)
    if mode == 'D1_2420_sideband':
        path_in = '/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/'+str(ecms)+'/rootfile/sigMC_D1_2420_'+str(ecms)+'.root'
        path_out = '/besfs/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/width/SHAPE_D1_2420_'+str(ecms)+'_sideband.root'
        shape_D1_2420_raw(path_in, path_out, ecms, cms, mode, xmin, xmax, xbins)
    if mode == 'D1_2420':
        path_signal = '/besfs/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/width/SHAPE_D1_2420_'+str(ecms)+'_signal.root'
        path_sideband = '/besfs/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/width/SHAPE_D1_2420_'+str(ecms)+'_sideband.root'
        path_out = '/besfs/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/width/SHAPE_D1_2420_'+str(ecms)+'.root'
