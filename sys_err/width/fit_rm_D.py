...
def main():
    ...
    root = []
    if ecms > 4290:
        path.append('/besfs/users/$USER/bes/DDPIPI/v0.2/data/'+str(ecms)+'/sys_err/width/data_'+str(ecms)+'_fit.root')
        path.append('/besfs/users/$USER/bes/DDPIPI/v0.2/data/'+str(ecms)+'/sys_err/width/data_'+str(ecms)+'_sideband_fit.root')
        path.append('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/psipp/'+str(ecms)+'/sys_err/width/sigMC_psipp_'+str(ecms)+'_fit.root')
        path.append('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/'+str(ecms)+'/sys_err/width/sigMC_D_D_PI_PI_'+str(ecms)+'_fit.root')
        shape.append('/besfs/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/width/SHAPE_D1_2420_'+str(ecms)+'.root')
        root.append('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/psipp/'+str(ecms)+'/sys_err/width/sigMC_psipp_'+str(ecms)+'_after.root')
        root.append('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/'+str(ecms)+'/sys_err/width/sigMC_D_D_PI_PI_'+str(ecms)+'_after.root')
        root.append('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/'+str(ecms)+'/sys_err/width/sigMC_D1_2420_'+str(ecms)+'_after.root')
