...
def fit(path, ecms, mode, patch):
    ...
    if (ecms == 4190 or ecms == 4200 or ecms == 4210 or ecms == 4237 or ecms == 4245 or ecms == 4270 or ecms == 4280) and mode == 'data':
        f_DDPIPI = TFile('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/' + str(ecms) + '/sys_err/width/sigMC_D_D_PI_PI_' + str(ecms) + '_raw_before.root')
...
def main():
    ...
    path = []
    if mode == 'data':
        path.append('/besfs/users/$USER/bes/DDPIPI/v0.2/data/' + str(ecms) + '/sys_err/width/data_' + str(ecms) + '_raw_before.root')
    if mode == 'D1_2420':
        path.append('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/' + str(ecms) + '/sys_err/width/sigMC_D1_2420_' + str(ecms) + '_raw_before.root')
    if mode == 'psipp':
        path.append('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/psipp/' + str(ecms) + '/sys_err/width/sigMC_psipp_' + str(ecms) + '_raw_before.root')
    if mode == 'DDPIPI':
        path.append('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/' + str(ecms) + '/sys_err/width/sigMC_D_D_PI_PI_' + str(ecms) + '_raw_before.root')
