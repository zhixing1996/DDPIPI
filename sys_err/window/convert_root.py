...
def main():
    ...
    if ecms > 4290:
        ...
        path_in.append('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/' + str(ecms) + '/sys_err/window/sigMC_D_D_PI_PI_' + str(ecms) + '_after.root')
        path_out.append('/besfs/users/$USER/bes/DDPIPI/v0.2/data/' + str(ecms) + '/sys_err/window/data_' + str(ecms) + '_fit.root')
        path_out.append('/besfs/users/$USER/bes/DDPIPI/v0.2/data/' + str(ecms) + '/sys_err/window/data_' + str(ecms) + '_sideband_fit.root')
        path_out.append('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/' + str(ecms) + '/sys_err/window/sigMC_D1_2420_' + str(ecms) + '_fit.root')
        path_out.append('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/psipp/' + str(ecms) + '/sys_err/window/sigMC_psipp_' + str(ecms) + '_fit.root')
        path_out.append('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/' + str(ecms) + '/sys_err/window/sigMC_D_D_PI_PI_' + str(ecms) + '_fit.root')
        mode.append('data')
