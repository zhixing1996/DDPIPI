...
def main():
    ...
    if mode == 'data':
        ...
        shape_path = '/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/mixed/sys_err/window/shape_' + str(ecms) + '_mixed.root'
    if mode == 'psipp' or mode == 'D1_2420':
        path.append('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/' + str(mode) + '/' + str(ecms) + '/sys_err/window/sigMC_' + str(mode) + '_' + str(ecms) + '_raw_before.root')
        shape_path = '/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/mixed/sys_err/window/shape_' + str(ecms) + '_mixed.root'
    if mode == 'DDPIPI':
        path.append('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/' + str(mode) + '/' + str(ecms) + '/sys_err/window/sigMC_D_D_PI_PI_' + str(ecms) + '_raw_before.root')
        shape_path = '/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/mixed/sys_err/window/shape_' + str(ecms) + '_mixed.root'
