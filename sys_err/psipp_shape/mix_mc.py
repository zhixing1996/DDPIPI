...
def main():
    ...
    if mode == 'MC_signal':
        path_in = '/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/'+process+'/'+str(ecms)+'/sys_err/psipp_shape/sigMC_' + process + '_'+str(ecms)+'_raw_before.root'
        path_out = '/besfs/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/psipp_shape/shape_'+process+'_'+str(ecms)+'_signal.root'
        shape_MC_raw(ecms, path_in, path_out, xmin, xmax, xbins)

    if mode == 'MC_sideband':
        path_in = '/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/'+process+'/'+str(ecms)+'/sys_err/psipp_shape/sigMC_' + process + '_'+str(ecms)+'_raw_sideband_before.root'
        path_out = '/besfs/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/psipp_shape/shape_'+process+'_'+str(ecms)+'_sideband.root'
        shape_MC_raw(ecms, path_in, path_out, xmin, xmax, xbins)

    if mode == 'MC_shape':
        path_signal = '/besfs/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/psipp_shape/shape_'+process+'_'+str(ecms)+'_signal.root'
        path_sideband = '/besfs/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/psipp_shape/shape_'+process+'_'+str(ecms)+'_sideband.root'
        path_out = '/besfs/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/psipp_shape/shape_'+process+'_'+str(ecms)+'.root'
    ...
    if mode == 'MC_mix':
        ...
        if ecms > 4290:
            ...
            path_in.append('/besfs/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/psipp_shape/shape_psipp_' + str(ecms) + '.root')
            path_in.append('/besfs/users/$USER/bes/DDPIPI/v0.2/ana/shape/shape_D_D_PI_PI_' + str(ecms) + '.root')
            path_out = '/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/mixed/sys_err/psipp_shape/shape_' + str(ecms) + '_mixed.root'
