...
do
    ...
    echo "EvtDecay.userDecayTableName = \"$HOME/bes/DDPIPI/v0.2/sys_err/psipp_shape/scripts/mc/psipp/psi4260_psipp_PI_PI_VSS.dec\";" >> $SIM_NAME
    echo "EvtDecay.PdtTableDir = \"$HOME/bes/DDPIPI/v0.2/sys_err/psipp_shape/scripts/mc/psipp/pdt_703p01.table\";" >> $SIM_NAME
