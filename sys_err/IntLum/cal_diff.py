#!/usr/bin/env python
"""
Calculate systematic uncertainty caused by luminosity measurement
"""

__author__ = "Maoqiang JING <jingmq@ihep.ac.cn>"
__copyright__ = "Copyright (c) Maoqiang JING"
__created__ = "[2020-04-07 Tue 23:27]"
...
def cal_diff():
    if not os.path.exists('./txts/'):
        os.makedirs('./txts/')
    path_sys_err = './txts/sys_err_IntLum.txt'
