...
void get_signal_hist_4420() {

    TFile *file_in = new TFile("/scratchfs/bes/jingmq/bes/DDPIPI/v0.1/sigMC/D1_2420/4420/rootfile/sigMC_D1_2420_4420.root", "READ");
    ...
    TFile file_out("/besfs/users/jingmq/DDPIPI/v0.1/sigMC/D1_2420/4420/signal_hist_4420.root","RECREATE");
