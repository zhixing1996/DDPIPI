...
void fit_rmD_4420() {
    ...
    TFile *file_data = new TFile("/besfs/users/$USER/DDPIPI/v0.1/data/4420/data_4420_control.root", "READ");
    TFile *file_sig = new TFile("/besfs/users/$USER/DDPIPI/v0.1/controlMC/DD/4420/controlMC_DD_4420.root", "READ");
