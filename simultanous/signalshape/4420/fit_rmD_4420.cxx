...
void fit_rmD_4420() {
    ...
    TFile *file_data = new TFile("/besfs/users/jingmq/DDPIPI/v0.1/data/4420/data_4420_control.root", "READ");
    TFile *file_sig = new TFile("/besfs/users/jingmq/DDPIPI/v0.1/controlMC/DD/4420/controlMC_DD_4420.root", "READ");
    ...
    RooRealVar mean("mean", "mean", 0., -0.1, 0.8);
    ...
    ofstream fout;
    fout.open("/besfs/users/jingmq/DDPIPI/v0.1/sigMC/D1_2420/4420/rmD_fitresult_4420.txt");
    if (!fout) {
        cout << "ERROR: Unable to open output file" << endl;
    }
    fout << "Resolution: " << sigma.getVal() << " +/- " << sigma.getError() << endl;
    canvas->Print("/besfs/users/jingmq/DDPIPI/v0.1/sigMC/D1_2420/4420/fit_rmD_4420.pdf");
