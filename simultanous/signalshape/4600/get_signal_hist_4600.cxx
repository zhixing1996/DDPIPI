...
void get_signal_hist_4600() {

    TFile *file_in = new TFile("/scratchfs/bes/jingmq/bes/DDPIPI/v0.1/sigMC/D1_2420/4600/rootfile/ana_Sig_D1_2420_D_PHSP_4600_0.root", "READ");
    ...
    TFile file_out("/besfs/users/jingmq/DDPIPI/v0.1/sigMC/D1_2420/4600/signal_hist_4600.root","RECREATE");
            ...
            for(Int_t k = 0; k < nentries; k++) {
                ...
                for (Int_t m = 0; m < nothertrks; m++) {
                    ...
                    for (Int_t n = 0; n < nothertrks; n++) {
                        ...
                        if (!(rmDpipi > 1.855 && rmDpipi < 1.882)) continue;
