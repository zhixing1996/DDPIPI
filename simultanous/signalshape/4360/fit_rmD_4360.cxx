...
void fit_rmD_4360() {
    ...
    TFile *file_data = new TFile("/besfs/users/$USER/DDPIPI/v0.1/data/4360/data_4360_control.root", "READ");
    TFile *file_sig = new TFile("/besfs/users/$USER/DDPIPI/v0.1/controlMC/DD/4360/controlMC_DD_4360.root", "READ");
