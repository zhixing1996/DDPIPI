...
void get_signal_hist_4360() {
    ...
    TFile file_out("/besfs/users/jingmq/DDPIPI/v0.1/sigMC/D1_2420/4360/signal_hist_4360.root","RECREATE");
    TH1F *h_mDstst = new TH1F("h_mDstst", "h_mDstst", 200, 2.1, 2.75);
    TH1F *h_[500][500];

    Double_t rmD,rmDpipi;
    TLorentzVector cms(0.011*4.358, 0, 0, 4.358);
