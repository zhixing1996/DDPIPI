...
void fit_rmDpipi_4360() {
    ...
    TFile *f = new TFile("/besfs/users/jingmq/DDPIPI/v0.1/data/4360/data_4360_selected.root", "READ");
    ...
    // build P.D.F model
    RooAddPdf model("model","gauss1+bkg",RooArgList(*CB, bkgpdf),RooArgList(nsig,nbkg));
    ...
    xframe->GetYaxis()->SetNdivisions(509);
    ...
    ofstream fout;
    fout.open("/besfs/users/jingmq/DDPIPI/v0.1/bkgMC/PHSP/4360/rmDpipi_fitresult_4360.txt");
    if (!fout) {
