...
void simu_fit_final()
{
	...
	for(int ii=0;ii<80;ii++) {
		for(int iii=0;iii<20;iii++) {
			...
			sprintf(canvas1,"/besfs/users/jingmq/DDPIPI/v0.1/ana/simu/canvas1_rmD_%d_%d.eps",ii,iii);
			sprintf(canvas2,"/besfs/users/jingmq/DDPIPI/v0.1/ana/simu/canvas2_rmD_%d_%d.eps",ii,iii);
			sprintf(canvas3,"/besfs/users/jingmq/DDPIPI/v0.1/ana/simu/canvas3_rmD_%d_%d.eps",ii,iii);
