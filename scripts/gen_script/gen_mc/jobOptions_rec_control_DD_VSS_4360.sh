...
echo "./jobOptions_rec_control_DD_VSS_4360.sh [NUM1] [NUM2]"
echo "[NUM1]: the minimum number range of job generated"
echo "[NUM2]: the maximum number range of job generated"

SEED=123
    
DIR_NAME_RTRAW="/scratchfs/bes/$USER/bes/DDPIPI/v0.1/controlMC/DD/4360/rtraw/"
DIR_NAME_DST="/scratchfs/bes/$USER/bes/DDPIPI/v0.1/controlMC/DD/4360/dst/"
EVENT_NO=-1

JOB_NAME="jobOptions_rec_control_DD_VSS_4360"
INPUT_NAME="Control_DD_VSS_4360"
OUTPUT_NAME="Control_DD_VSS_4360"
