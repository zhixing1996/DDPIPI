...
DIR_NAME="/scratchfs/bes/$USER/bes/DDPIPI/v0.1/bkgMC/PHSP/4360/rtraw/"
EVENT_NO=$3

echo "./jobOptions_sim_bkg_PHSP_PHSP_4360.sh [NUM1] [NUM2] [NUM3]"
...
JOB_NAME="jobOptions_sim_bkg_PHSP_PHSP"
FILE_NAME="Bkg_PHSP_PHSP"
...
do
    ...
    echo "EvtDecay.userDecayTableName = \"$HOME/bes/DDPIPI/v0.1/scripts/gen_script/gen_mc/decay/psi4415_PHSP_PHSP.dec\";" >> $SIM_NAME
