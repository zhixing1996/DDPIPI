...
echo "./jobOptions_rec_sig_psipp_PI_PI_PHSP_4600.sh [NUM1] [NUM2]"
echo "[NUM1]: the minimum number range of job generated"
echo "[NUM2]: the maximum number range of job generated"

SEED=123
    
DIR_NAME_RTRAW="/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/psipp/4600/rtraw/"
DIR_NAME_DST="/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/psipp/4600/dst/"
EVENT_NO=-1

JOB_NAME="jobOptions_rec_sig_psipp_PI_PI_PHSP_4600"
INPUT_NAME="Sig_psipp_PI_PI_PHSP_4600"
OUTPUT_NAME="Sig_psipp_PI_PI_PHSP_4600"
