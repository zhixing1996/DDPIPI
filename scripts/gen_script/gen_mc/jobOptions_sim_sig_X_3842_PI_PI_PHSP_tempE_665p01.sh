...
DIR_NAME="/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/X_3842/TEMP_0/rtraw/"
EVENT_NO=$3

echo "./jobOptions_sim_sig_X_3842_PI_PI_PHSP_TEMP_0.sh [NUM1] [NUM2] [NUM3]"
...
do
    ...
    echo "EvtDecay.PdtTableDir = \"$HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/decay/pdt_665p01.table\";" >> $SIM_NAME
