...
echo "./jobOptions_rec_sig_D_D_PI_TEMP_0.sh [NUM1] [NUM2]"
echo "[NUM1]: the minimum number range of job generated"
echo "[NUM2]: the maximum number range of job generated"

SEED=123
    
DIR_NAME_RTRAW="/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/DDPI/TEMP_0/rtraw/"
DIR_NAME_DST="/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/DDPI/TEMP_0/dst/"
EVENT_NO=-1

JOB_NAME="jobOptions_rec_sig_D_D_PI_TEMP_0"
INPUT_NAME="Sig_D_D_PI_TEMP_0"
OUTPUT_NAME="Sig_D_D_PI_TEMP_0"
