...
do
    ...
    rm -rf /besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/DDPI/$PARAM_0/*signal*.root
    rm -rf /besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/DDPI/$PARAM_0/*raw*.root
    ...
    python get_info.py $FILE_PATH/sigMC_D_D_PI_$PARAM_0\.root $ROOT_PATH/sigMC_D_D_PI_$PARAM_0\_raw_sidebandup.root $PARAM_3 raw_sidebandup
