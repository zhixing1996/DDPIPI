...
do
    ...
    mkdir -p $WORKAREA/sigMC/DDPI/$PARAM_0
    cd $HOME/bes/DDPIPI/v0.2/python
    # rm -rf /besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/DDPI/$PARAM_0/*before*.root
    # rm -rf /besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/DDPI/$PARAM_0/*after*.root
    ROOT_PATH=/besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/DDPI/$PARAM_0

    echo "Begininning of $PARAM_0!"

    # python apply_cuts.py $ROOT_PATH/sigMC_D_D_PI_$PARAM_0\_raw.root $ROOT_PATH/sigMC_D_D_PI_$PARAM_0\_raw_before.root $PARAM_0 before raw_signal
    # echo "STD signal of $PARAM_0 is done!"

    # python apply_cuts.py $ROOT_PATH/sigMC_D_D_PI_$PARAM_0\_signal.root $ROOT_PATH/sigMC_D_D_PI_$PARAM_0\_before.root $PARAM_0 before STDDmiss_signal
    ...
    python apply_cuts.py $ROOT_PATH/sigMC_D_D_PI_$PARAM_0\_raw_sidebandup.root $ROOT_PATH/sigMC_D_D_PI_$PARAM_0\_raw_sidebandup_after.root $PARAM_0 after raw_sidebandup
    hadd $ROOT_PATH/sigMC_D_D_PI_$PARAM_0\_raw_sideband_after.root $ROOT_PATH/sigMC_D_D_PI_$PARAM_0\_raw_sidebandlow_after.root $ROOT_PATH/sigMC_D_D_PI_$PARAM_0\_raw_sidebandup_after.root
