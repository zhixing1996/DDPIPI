...
DIR_NAME="/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/D0_2300/4360/rtraw/"
EVENT_NO=$3

echo "./jobOptions_sim_sig_D0_2300_D_PI_PHSP_4360.sh [NUM1] [NUM2] [NUM3]"
...
JOB_NAME="jobOptions_sim_sig_D0_2300_D_PI_PHSP"
FILE_NAME="Sig_D0_2300_D_PI_PHSP"
...
do
    ...
    echo "KKMC.CMSEnergy = 4.35826;" >> $SIM_NAME
    echo "KKMC.BeamEnergySpread=0.00197;" >> $SIM_NAME
    ...
    echo "EvtDecay.userDecayTableName = \"$HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/decay/psi4415_D0_2300_D_PI_PHSP.dec\";" >> $SIM_NAME
    ...
    echo "RealizationSvc.RunIdList = {-30616, 0, -31279};" >> $SIM_NAME
    echo "" >> $SIM_NAME
