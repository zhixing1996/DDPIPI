...
DIR_NAME="/scratchfs/bes/$USER/bes/DDPIPI/v0.1/controlMC/DD/4360/rtraw/"
EVENT_NO=$3

echo "./jobOptions_sim_control_DD_VSS_4360.sh [NUM1] [NUM2] [NUM3]"
...
JOB_NAME="jobOptions_sim_control_DD_VSS"
FILE_NAME="Control_DD_VSS"
