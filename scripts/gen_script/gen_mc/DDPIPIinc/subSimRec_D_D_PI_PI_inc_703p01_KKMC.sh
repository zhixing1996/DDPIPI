...
do
    ...
    rm -rf subSimRec_*.sh
    rm -rf xs_user.dat
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/DDPIPIinc/jobOptions_sim_sig_D_D_PI_PI_inc_tempE_703p01_KKMC.sh ./jobOptions_sim_sig_D_D_PI_PI_inc_$PARAM_0\.sh
    ...
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/DDPIPIinc/jobOptions_rec_sig_D_D_PI_PI_inc_tempE_703p01.sh ./jobOptions_rec_sig_D_D_PI_PI_inc_$PARAM_0\.sh
    ...
    sh subSimRec.sh jobOptions_sim_sig_D_D_PI_PI_inc_$PARAM_0 jobOptions_rec_sig_D_D_PI_PI_inc_$PARAM_0 subSimRec_DDPIPIinc_$PARAM_0\_703p01 0 9
done
