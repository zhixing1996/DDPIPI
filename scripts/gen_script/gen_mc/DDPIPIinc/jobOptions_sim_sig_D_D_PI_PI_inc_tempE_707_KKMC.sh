...
DIR_NAME="/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPIinc/TEMP_0/rtraw/"
EVENT_NO=$3

echo "./jobOptions_sim_sig_D_D_PI_PI_inc_TEMP_0.sh [NUM1] [NUM2] [NUM3]"
...
JOB_NAME="jobOptions_sim_sig_D_D_PI_PI_inc"
FILE_NAME="Sig_D_D_PI_PI_inc"
...
do
    ...
    echo "EvtDecay.userDecayTableName = \"$HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/decay/psi4260_D_D_PI_PI_inc.dec\";" >> $SIM_NAME
