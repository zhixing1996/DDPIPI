...
do
    ...
    rm -rf sigMC_D_D_PI_PI_inc_PHSP_$PARAM_0*txt
    cp -rf $HOME/bes/DDPIPI/v0.2/python/make_mc.py ./
    cp -rf $HOME/bes/DDPIPI/v0.2/python/tools.py ./
    ./make_mc.py /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPIinc/$PARAM_0/dst sigMC D_D_PI_PI_inc PHSP DDPIPIinc $PARAM_0 $PARAM_3 2
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/subAna.sh ./
    rm -rf *boss*
    rm -rf /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPIinc/$PARAM_0/rootfile/*root
    ./subAna.sh sigMC_D_D_PI_PI_inc_PHSP_$PARAM_0
done
