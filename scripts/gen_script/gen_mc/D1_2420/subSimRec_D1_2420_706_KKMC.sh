...
do
    ...
    rm -rf subSimRec_*.sh
    rm -rf xs_user.dat
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/D1_2420/jobOptions_sim_sig_D1_2420_D_tempE_706_KKMC.sh ./jobOptions_sim_sig_D1_2420_D_$PARAM_0\.sh
    ...
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/D1_2420/jobOptions_rec_sig_D1_2420_D_tempE_706.sh ./jobOptions_rec_sig_D1_2420_D_$PARAM_0\.sh
    ...
    sh subSimRec.sh jobOptions_sim_sig_D1_2420_D_$PARAM_0 jobOptions_rec_sig_D1_2420_D_$PARAM_0 subSimRec_D1_2420_$PARAM_0\_706 0 9
done
