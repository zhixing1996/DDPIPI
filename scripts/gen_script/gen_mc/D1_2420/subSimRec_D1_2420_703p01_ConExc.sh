...
do
    ...
    rm -rf subSimRec_*.sh
    rm -rf xs_user.txt
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/D1_2420/jobOptions_sim_sig_D1_2420_D_tempE_703p01_${GEN}.sh ./jobOptions_sim_sig_D1_2420_D_$PARAM_0\.sh
