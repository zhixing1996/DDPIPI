...
do
    ...
    rm -rf subSimRec_*.sh
    rm -rf xs_user.txt
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/psipp/jobOptions_sim_sig_psipp_PI_PI_tempE_703p01_${GEN}.sh ./jobOptions_sim_sig_psipp_PI_PI_$PARAM_0\.sh
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/decay/${GEN}_psipp_PI_PI.dec .
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/psipp/xs_user.txt ./xs_user.txt
    ...
    sed -i "s/ECMS/$PARAM_3/g" ${GEN}_psipp_PI_PI.dec
    ...
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/psipp/jobOptions_rec_sig_psipp_PI_PI_tempE_703p01.sh ./jobOptions_rec_sig_psipp_PI_PI_$PARAM_0\.sh
