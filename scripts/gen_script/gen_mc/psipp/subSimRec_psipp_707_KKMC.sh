...
do
    ...
    rm -rf subSimRec_*.sh
    rm -rf xs_user.dat
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/psipp/jobOptions_sim_sig_psipp_PI_PI_tempE_707_KKMC.sh ./jobOptions_sim_sig_psipp_PI_PI_$PARAM_0\.sh
    ...
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/psipp/jobOptions_rec_sig_psipp_PI_PI_tempE_707.sh ./jobOptions_rec_sig_psipp_PI_PI_$PARAM_0\.sh
