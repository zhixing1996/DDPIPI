...
do
    ...
    rm -rf subSimRec_*.sh
    rm -rf xs_user.dat
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/X_3842/jobOptions_sim_sig_Sigma_X_3842_tempE_707_KKMC.sh ./jobOptions_sim_sig_Sigma_X_3842_$PARAM_0\.sh
    ...
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/X_3842/jobOptions_rec_sig_Sigma_X_3842_tempE_707.sh ./jobOptions_rec_sig_Sigma_X_3842_$PARAM_0\.sh
    ...
    sh subSimRec.sh jobOptions_sim_sig_Sigma_X_3842_$PARAM_0 jobOptions_rec_sig_Sigma_X_3842_$PARAM_0 subSimRec_X_3842_$PARAM_0\_707 0 9
done
