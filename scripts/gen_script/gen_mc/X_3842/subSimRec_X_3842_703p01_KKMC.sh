...
do
    ...
    cd jobs_sig
    mkdir -p /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/X_3842/$PARAM_0/rtraw
    mkdir -p /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/X_3842/$PARAM_0/dst
    rm -rf jobOptions*txt
    rm -rf subSimRec_*.sh
    rm -rf xs_user.dat
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/X_3842/jobOptions_sim_sig_Sigma_X_3842_tempE_703p01_KKMC.sh ./jobOptions_sim_sig_Sigma_X_3842_$PARAM_0\.sh
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/X_3842/xs_user.dat ./xs_user.dat
    ...
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/X_3842/jobOptions_rec_sig_Sigma_X_3842_tempE_703p01.sh ./jobOptions_rec_sig_Sigma_X_3842_$PARAM_0\.sh
    ...
    sh subSimRec.sh jobOptions_sim_sig_Sigma_X_3842_$PARAM_0 jobOptions_rec_sig_Sigma_X_3842_$PARAM_0 subSimRec_X_3842_$PARAM_0\_703p01 0 9
done
