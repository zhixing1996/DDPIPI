...
do
    ...
    rm -rf subSimRec_*.sh
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/X_3842/jobOptions_sim_sig_X_3842_PI_PI_PHSP_tempE_703p01.sh ./jobOptions_sim_sig_X_3842_PI_PI_PHSP_$PARAM_0\.sh
    ...
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/X_3842/jobOptions_rec_sig_X_3842_PI_PI_PHSP_tempE_703p01.sh ./jobOptions_rec_sig_X_3842_PI_PI_PHSP_$PARAM_0\.sh
