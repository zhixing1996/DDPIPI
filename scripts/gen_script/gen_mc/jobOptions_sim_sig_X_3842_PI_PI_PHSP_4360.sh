...
DIR_NAME="/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/X_3842/4360/rtraw/"
EVENT_NO=$3

echo "./jobOptions_sim_sig_X_3842_PI_PI_PHSP_4360.sh [NUM1] [NUM2] [NUM3]"
...
JOB_NAME="jobOptions_sim_sig_X_3842_PI_PI_PHSP"
FILE_NAME="Sig_X_3842_PI_PI_PHSP"
...
do
    ...
    echo "EvtDecay.userDecayTableName = \"$HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/decay/psi4415_X_3842_PI_PI_PHSP.dec\";" >> $SIM_NAME
