...
do
    ...
    rm -rf subSimRec_*.sh
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/jobOptions_sim_sig_psipp_PI_PI_VSS_tempE_665p01.sh ./jobOptions_sim_sig_psipp_PI_PI_VSS_$PARAM_0\.sh
    ...
    sh jobOptions_sim_sig_psipp_PI_PI_VSS_$PARAM_0\.sh 0 3 5000
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/jobOptions_rec_sig_psipp_PI_PI_VSS_tempE_665p01.sh ./jobOptions_rec_sig_psipp_PI_PI_VSS_$PARAM_0\.sh
    ...
    sh jobOptions_rec_sig_psipp_PI_PI_VSS_$PARAM_0\.sh 0 3
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/subSimRec.sh ./
    sh subSimRec.sh jobOptions_sim_sig_psipp_PI_PI_VSS_$PARAM_0 jobOptions_rec_sig_psipp_PI_PI_VSS_$PARAM_0 subSimRec_psipp_$PARAM_0\_665p01 0 3
done
