...
def make_significance():
    ...
    with open('./texs/significance.tex', 'w') as f:
        ...
        f.write('\t\centering\n')
        f.write('\t\caption{Significance of each data sample.}\n')
    ...
    with open('./texs/upl.tex', 'w') as f:
        ...
        f.write('\t\\begin{tabular}{cccc}\n')
        f.write('\t\hline\hline\n')
        f.write('\tData Sample& $\sigma_{upl}(pb)$ & Data Sample& $\sigma_{upl}(pb)$\\\\\n')
        f.write('\t\hline\n')
        f.write('\t{:^4}& {:^4}& {:^4}& {:^4}\\\\\n'.format(4190, upl[0], 4270, upl[6]))
        f.write('\t{:^4}& {:^4}& {:^4}& {:^4}\\\\\n'.format(4200, upl[1], 4280, upl[7]))
        f.write('\t{:^4}& {:^4}& {:^4}& {:^4}\\\\\n'.format(4210, upl[2], 4310, upl[8]))
        f.write('\t{:^4}& {:^4}& {:^4}& {:^4}\\\\\n'.format(4220, upl[3], 4575, upl[9]))
        f.write('\t{:^4}& {:^4}& {:^4}& {:^4}\\\\\n'.format(4237, upl[4], 4610, upl[10]))
        f.write('\t{:^4}& {:^4}& -    & -    \\\\\n'.format(4245, upl[5]))
        f.write('\t\hline\hline\n')
        f.write('\t\end{tabular}\n')
