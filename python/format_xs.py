...
def format(patch):
    ...
    ecms = [4190, 4200, 4210, 4220, 4230, 4237, 4245, 4246, 4260, 4270, 4280, 4290, 4310, 4315, 4340, 4360, 4380, 4390, 4400, 4420, 4440, 4470, 4530, 4600]
    for ecm in ecms:
        ...
        for line_xs in lines_xs:
            ...
            VP = float(rs_xs[11])
            xs_D1_2420 = float(rs_xs[12])
            xs_psipp = float(rs_xs[13])
            xs_DDPIPI = float(rs_xs[14])
            lum = float(rs_xs[15])
