#!/usr/bin/env python
"""
Plot invariant mass of tagged D and selected piplu piminus
"""

__author__ = "Maoqiang JING <jingmq@ihep.ac.cn>"
__copyright__ = "Copyright (c) Maoqiang JING"
__created__ = "[2019-11-06 Wed 00:11]"
...
def plot(data_path, incMC1_path, incMC2_path, sigMC1_path, sigMC2_path, leg_title, ecms, scale1, scale2, scale3, scale4, xmax, runNolow, runNoup, ymax):
    try:
...
if __name__ == '__main__':
    ...
    runNolow = 36773
    runNoup = 38140
    plot(data_path, incMC1_path, incMC2_path, sigMC1_path, sigMC2_path, leg_title, ecms, scale1, scale2, scale3, scale4, xmax, runNolow, runNoup, ymax)
