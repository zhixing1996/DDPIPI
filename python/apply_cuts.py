...
def save_before(f_in, t, chi2_kf_cut_before):
    ...
    for ientry in range(nentries):
        ...
        if t_in.m_m_pipi > 0.28 and t_in.m_chi2_kf < chi2_kf_cut_before and t_in.m_rm_Dpipi > 1.855 and t_in.m_rm_Dpipi < 1.885:
...
def save_after(f_in, t, chi2_kf_cut_after):
    ...
    for ientry in range(nentries):
        t_in.GetEntry(ientry)
        if t_in.m_m_pipi > 0.28 and t_in.m_chi2_kf < chi2_kf_cut_after and t_in.m_rm_Dpipi > 1.855 and t_in.m_rm_Dpipi < 1.885 and (t_in.m_n_pi0 == 0 or (t_in.m_n_pi0 != 0 and (t_in.m_m_Dpi0 > 2.01165 or t_in.m_m_Dpi0 < 2.00871))) and (t_in.m_m_D0 < 1.80397 or t_in.m_m_D0 > 1.91843) and (t_in.m_m_D0 < 2.00117 or t_in.m_m_D0 > 2.01798) and (t_in.m_m_pipi < 0.49147 or t_in.m_m_pipi > 0.50364) and t_in.m_chi2_vf < 25:
            m_runNo[0] = t_in.m_runNo
            m_evtNo[0] = t_in.m_evtNo
            m_mode[0] = t_in.m_mode
            m_charm[0] = t_in.m_charm
