...
do
    ...
    rm -rf /besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/$PARAM_0/*before*.root
    rm -rf /besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/$PARAM_0/*after*.root
