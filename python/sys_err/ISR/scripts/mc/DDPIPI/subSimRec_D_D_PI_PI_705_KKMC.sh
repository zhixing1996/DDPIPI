...
do
    ...
    rm -rf subSimRec_*.sh
    rm -rf xs_user.dat
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/ISR/scripts/mc/DDPIPI/jobOptions_sim_sig_D_D_PI_PI_tempE_705_KKMC.sh ./jobOptions_sim_sig_D_D_PI_PI_$PARAM_0\.sh
    ...
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/ISR/scripts/mc/DDPIPI/jobOptions_rec_sig_D_D_PI_PI_tempE_705.sh ./jobOptions_rec_sig_D_D_PI_PI_$PARAM_0\.sh
    ...
    sh subSimRec.sh jobOptions_sim_sig_D_D_PI_PI_$PARAM_0 jobOptions_rec_sig_D_D_PI_PI_$PARAM_0 subSimRec_DDPIPI_$PARAM_0\_705 0 9
done
