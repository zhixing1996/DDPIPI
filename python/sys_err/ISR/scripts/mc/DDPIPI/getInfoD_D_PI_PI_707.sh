...
do
    ...
    rm -rf /besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/*signal*.root
    rm -rf /besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/*raw*.root
    ROOT_PATH=/besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0
    FILE_PATH=/besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/rootfile
