...
DIR_NAME="/besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/TEMP_0/rtraw/"
EVENT_NO=$3
...
do
    ...
    echo "EvtDecay.userDecayTableName = \"$HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/decay/psi4260_D_D_PI_PI.dec\";" >> $SIM_NAME
    echo "EvtDecay.PdtTableDir = \"$HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/decay/pdt_707.table\";" >> $SIM_NAME
