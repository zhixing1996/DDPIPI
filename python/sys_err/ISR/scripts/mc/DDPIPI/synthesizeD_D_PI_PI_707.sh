...
do
    ...
    cd /besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/rootfile
    ...
    if [[ $PARAM_0 == *$shortbar1* ]]; then
        ...
        mkdir -p $dir
        mv /besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/rootfile/sigMC_D_D_PI_PI_$PARAM_0\.root ./$dir
    fi
