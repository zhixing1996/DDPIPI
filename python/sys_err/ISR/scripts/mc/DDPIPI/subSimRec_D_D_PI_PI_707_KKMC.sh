...
do
    ...
    cd jobs_sig
    mkdir -p /besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/rtraw
    mkdir -p /besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/dst
    rm -rf jobOptions*txt
    rm -rf subSimRec_*.sh
    rm -rf xs_user.dat
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/ISR/scripts/mc/DDPIPI/jobOptions_sim_sig_D_D_PI_PI_tempE_707_KKMC.sh ./jobOptions_sim_sig_D_D_PI_PI_$PARAM_0\.sh
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/ISR/scripts/mc/DDPIPI/xs_user.dat ./xs_user.dat
    ...
    rm -rf /besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/rtraw/*.rtraw
    sh jobOptions_sim_sig_D_D_PI_PI_$PARAM_0\.sh 0 9 5000
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/ISR/scripts/mc/DDPIPI/jobOptions_rec_sig_D_D_PI_PI_tempE_707.sh ./jobOptions_rec_sig_D_D_PI_PI_$PARAM_0\.sh
    sed -i "s/TEMP_0/$PARAM_0/g" jobOptions_rec_sig_D_D_PI_PI_$PARAM_0\.sh
    rm -rf /besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/dst/*.dst
    sh jobOptions_rec_sig_D_D_PI_PI_$PARAM_0\.sh 0 9
    cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/subSimRec.sh ./
    sh subSimRec.sh jobOptions_sim_sig_D_D_PI_PI_$PARAM_0 jobOptions_rec_sig_D_D_PI_PI_$PARAM_0 subSimRec_DDPIPI_$PARAM_0\_707 0 9
done
