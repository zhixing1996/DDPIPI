...
do
    ...
    rm -rf /besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0/*signal*.root
    rm -rf /besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0/*raw*.root
    ROOT_PATH=/besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0
    FILE_PATH=/besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0/rootfile
    ...
    python get_info.py $FILE_PATH/sigMC_psipp_$PARAM_0\.root $ROOT_PATH/sigMC_psipp_$PARAM_0\_truth.root $PARAM_3 truth
