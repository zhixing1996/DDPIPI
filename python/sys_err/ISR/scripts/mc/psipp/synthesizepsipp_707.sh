...
do
    ...
    cd /besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0/rootfile
    ...
    if [[ $PARAM_0 == *$shortbar1* ]]; then
        ...
        mkdir -p $dir
        mv /besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0/rootfile/sigMC_psipp_$PARAM_0\.root ./$dir
    fi
