...
do
    ...
    rm -rf /besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0/*before*.root
    rm -rf /besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0/*after*.root
    ROOT_PATH=/besfs5/groups/psip/psipgroup/user/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0
    ...
    python apply_cuts.py $ROOT_PATH/sigMC_psipp_$PARAM_0\_raw.root $ROOT_PATH/sigMC_psipp_$PARAM_0\_rm_Dpipi_signal.root $PARAM_0 after rm_Dpipi_signal
    ...
    rm -rf $ROOT_PATH/sigMC_psipp_$PARAM_0\_raw_sideband_before.root
