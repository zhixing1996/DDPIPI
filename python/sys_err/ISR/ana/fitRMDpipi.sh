#!/bin/sh
PATCH=$1
rm $HOME/bes/DDPIPI/v0.2/python/sys_err/ISR/txts/data_signal_events_total_${PATCH}.txt -rf
rm $HOME/bes/DDPIPI/v0.2/python/sys_err/ISR/txts/sideband_signal_events_total_${PATCH}.txt -rf
