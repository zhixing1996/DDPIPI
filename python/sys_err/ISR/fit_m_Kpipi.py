...
def main():
    ...
    if mode == 'data':
        ...
        shape_path = '/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/mixed/sys_err/ISR/shape_' + str(ecms) + '_mixed_raw.root'
        fit(path, ecms, mode, shape_path)
    if mode == 'MC':
        path.append('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/mixed/sys_err/ISR/sigMC_mixed_width_' + str(ecms) + '_raw.root')
        shape_path = '/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/mixed/sys_err/ISR/shape_' + str(ecms) + '_mixed_raw.root'
        fit(path, ecms, mode, shape_path)
