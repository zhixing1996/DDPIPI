...
do
    ...
    # WORKAREA=/scratchfs/bes/$USER/bes/DDPIPI/v0.2/run/gen_mc/sigMC/psipp/$PARAM_0/sys_err/ISR/jobs_sig/jobs.out
    WORKAREA=/besfs/groups/cal/dedx/$USER/bes/DDPIPI/v0.2/run/gen_mc/sigMC/psipp/$PARAM_0/sys_err/ISR/jobs_sig/jobs.out
