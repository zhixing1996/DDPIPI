...
# DIR_NAME="/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/TEMP_0/sys_err/ISR/rtraw/"
DIR_NAME="/besfs/groups/cal/dedx/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/TEMP_0/sys_err/ISR/rtraw/"
EVENT_NO=$3

echo "./jobOptions_sim_sig_D_D_PI_PI_TEMP_0.sh [NUM1] [NUM2] [NUM3]"
...
JOB_NAME="jobOptions_sim_sig_D_D_PI_PI"
FILE_NAME="Sig_D_D_PI_PI"
...
do
    ...
    echo "EvtDecay.userDecayTableName = \"$HOME/bes/DDPIPI/v0.2/python/sys_err/ISR/gen_mc/decay/psi4260_D_D_PI_PI.dec\";" >> $SIM_NAME
    echo "EvtDecay.PdtTableDir = \"$HOME/bes/DDPIPI/v0.2/python/sys_err/ISR/gen_mc/decay/pdt_703p01.table\";" >> $SIM_NAME
