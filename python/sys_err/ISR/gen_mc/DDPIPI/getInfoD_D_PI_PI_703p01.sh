...
do
    ...
    mkdir -p $WORKAREA/sigMC/DDPIPI/$PARAM_0/sys_err/ISR
    cd $HOME/bes/DDPIPI/v0.2/python/sys_err/ISR
    rm -rf $WORKAREA/sigMC/DDPIPI/$PARAM_0/sys_err/ISR/*signal*.root
    rm -rf $WORKAREA/sigMC/DDPIPI/$PARAM_0/sys_err/ISR/*raw*.root
    ROOT_PATH=$WORKAREA/sigMC/DDPIPI/$PARAM_0/sys_err/ISR
    # FILE_PATH=/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/sys_err/ISR/rootfile
    FILE_PATH=/besfs/groups/cal/dedx/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/sys_err/ISR/rootfile
