...
do
    ...
    # mkdir -p /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/$PARAM_0/sys_err/ISR/rtraw
    # mkdir -p /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/$PARAM_0/sys_err/ISR/dst
    ...
    mkdir -p /besfs/groups/cal/dedx/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/$PARAM_0/sys_err/ISR/rtraw
    mkdir -p /besfs/groups/cal/dedx/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/$PARAM_0/sys_err/ISR/dst
    rm -rf jobOptions*txt
    rm -rf subSimRec_*.sh
    rm -rf xs_user.dat
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/ISR/gen_mc/D1_2420/jobOptions_sim_sig_D1_2420_D_tempE_703p01_KKMC.sh ./jobOptions_sim_sig_D1_2420_D_$PARAM_0\.sh
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/ISR/gen_mc/D1_2420/xs_user.dat ./xs_user.dat
    ...
    # rm -rf /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/$PARAM_0/sys_err/ISR/rtraw/*.rtraw
    rm -rf /besfs/groups/cal/dedx/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/$PARAM_0/sys_err/ISR/rtraw/*.rtraw
    sh jobOptions_sim_sig_D1_2420_D_$PARAM_0\.sh 0 9 5000
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/ISR/gen_mc/D1_2420/jobOptions_rec_sig_D1_2420_D_tempE_703p01.sh ./jobOptions_rec_sig_D1_2420_D_$PARAM_0\.sh
    sed -i "s/TEMP_0/$PARAM_0/g" jobOptions_rec_sig_D1_2420_D_$PARAM_0\.sh
    # rm -rf /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/$PARAM_0/sys_err/ISR/dst/*.dst
    rm -rf /besfs/groups/cal/dedx/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/$PARAM_0/sys_err/ISR/dst/*.dst
