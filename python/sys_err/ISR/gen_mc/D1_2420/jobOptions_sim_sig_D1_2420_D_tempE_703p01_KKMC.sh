...
# DIR_NAME="/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/TEMP_0/sys_err/ISR/rtraw/"
DIR_NAME="/besfs/groups/cal/dedx/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/TEMP_0/sys_err/ISR/rtraw/"
EVENT_NO=$3
...
do
    ...
    echo "EvtDecay.userDecayTableName = \"$HOME/bes/DDPIPI/v0.2/python/sys_err/ISR/gen_mc/decay/psi4260_D1_2420_D.dec\";" >> $SIM_NAME
