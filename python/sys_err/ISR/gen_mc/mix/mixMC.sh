#!/bin/sh
PATCH=$1
mkdir -p /besfs/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/ISR
mkdir -p /besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/mixed/sys_err/ISR
cat mix_Base | while read line
do
    str=$line
    OLD_IFS=$IFS
    IFS=";"
