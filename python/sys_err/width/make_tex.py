...
def make_sys():
    ...
    with open('./texs/width_f.tex', 'w') as f:
        ...
        f.write('\t\hline\n')
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[0],  F[0],  Ferr[0],  F_Ferr[0],  sample[19], F[19], Ferr[19], F_Ferr[19]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[1],  F[1],  Ferr[1],  F_Ferr[1],  sample[20], F[20], Ferr[20], F_Ferr[20]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[2],  F[2],  Ferr[2],  F_Ferr[2],  sample[21], F[21], Ferr[21], F_Ferr[21]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[3],  F[3],  Ferr[3],  F_Ferr[3],  sample[22], F[22], Ferr[22], F_Ferr[22]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[4],  F[4],  Ferr[4],  F_Ferr[4],  sample[23], F[23], Ferr[23], F_Ferr[23]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[5],  F[5],  Ferr[5],  F_Ferr[5],  sample[24], F[24], Ferr[24], F_Ferr[24]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[6],  F[6],  Ferr[6],  F_Ferr[6],  sample[25], F[25], Ferr[25], F_Ferr[25]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[7],  F[7],  Ferr[7],  F_Ferr[7],  sample[26], F[26], Ferr[26], F_Ferr[26]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[8],  F[8],  Ferr[8],  F_Ferr[8],  sample[27], F[27], Ferr[27], F_Ferr[27]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[9],  F[9],  Ferr[9],  F_Ferr[9],  sample[28], F[28], Ferr[28], F_Ferr[28]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[10], F[10], Ferr[10], F_Ferr[10], sample[29], F[29], Ferr[29], F_Ferr[29]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[11], F[11], Ferr[11], F_Ferr[11], sample[30], F[30], Ferr[30], F_Ferr[30]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[12], F[12], Ferr[12], F_Ferr[12], sample[31], F[31], Ferr[31], F_Ferr[31]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[13], F[13], Ferr[13], F_Ferr[13], sample[32], F[32], Ferr[32], F_Ferr[32]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[14], F[14], Ferr[14], F_Ferr[14], sample[33], F[33], Ferr[33], F_Ferr[33]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[15], F[15], Ferr[15], F_Ferr[15], sample[34], F[34], Ferr[34], F_Ferr[34]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[16], F[16], Ferr[16], F_Ferr[16], sample[35], F[35], Ferr[35], F_Ferr[35]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& {:^4}& {:^4}$\pm${:^4}& {:^4}\\\\\n'.format(sample[17], F[17], Ferr[17], F_Ferr[17], sample[36], F[36], Ferr[36], F_Ferr[36]))
        f.write('\t{:^4}& {:^4}$\pm${:^4}& {:^4}& -    & -    & -    \\\\\n'.format(sample[18], F[18], Ferr[18], F_Ferr[18]))
        f.write('\t\hline\hline\n')
        f.write('\t\end{tabular}\n')
