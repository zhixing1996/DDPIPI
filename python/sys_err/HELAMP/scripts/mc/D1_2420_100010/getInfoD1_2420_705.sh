...
do
    ...
    mkdir -p $WORKAREA/sigMC/D1_2420_100010/$PARAM_0
    cd $HOME/bes/DDPIPI/v0.2/python
    rm -rf /besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420_100010/$PARAM_0/*signal*.root
    rm -rf /besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420_100010/$PARAM_0/*raw*.root
    ROOT_PATH=/besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420_100010/$PARAM_0
    FILE_PATH=/besfs5/groups/cal/dedx/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420_100010/$PARAM_0/rootfile
