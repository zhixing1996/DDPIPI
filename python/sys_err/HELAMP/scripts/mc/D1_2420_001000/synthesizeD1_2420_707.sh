...
do
    ...
    cd /besfs5/groups/cal/dedx/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420_001000/$PARAM_0/rootfile
    ...
    if [[ $PARAM_0 == *$shortbar1* ]]; then
        ...
        mkdir -p $dir
        mv /besfs5/groups/cal/dedx/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420_001000/$PARAM_0/rootfile/sigMC_D1_2420_$PARAM_0\.root ./$dir
    fi
