...
DIR_NAME="/besfs5/groups/cal/dedx/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420_001000/TEMP_0/rtraw/"
EVENT_NO=$3
...
do
    ...
    echo "EvtDecay.userDecayTableName = \"$HOME/bes/DDPIPI/v0.2/python/sys_err/HELAMP/scripts/mc/D1_2420_001000/psi4260_D1_2420_001000.dec\";" >> $SIM_NAME
