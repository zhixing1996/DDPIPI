...
def fit(path, shape_path, ecms, mode, patch):
    ...
    while True:
        ...
        if mode == 'D1_2420_001000' or mode == 'D1_2420_100010': is_OK = -1
...
def main():
    ...
    path = []
    shape_path = ''
    path.append('/besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/' + mode + '/' + str(ecms) + '/sigMC_D1_2420_' + str(ecms) + '_raw_sideband_after.root')
    shape_path = '/besfs5/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/HELAMP/shape_' + mode + '_' + str(ecms) + '_signal.root'
