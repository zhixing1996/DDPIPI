...
usage() {
    ...
    printf "\n\t%-9s  %-40s\n" "0.1.3" "Simulation & Reconstruction -- generate D1_2420 MC sample(@707)"
    printf "\n\t%-9s  %-40s\n" "0.1.4" "Single D tag -- run on D1_2420 MC sample(@703p01)"
    printf "\n\t%-9s  %-40s\n" "0.1.5" "Single D tag -- run on D1_2420 MC sample(@705)"
    printf "\n\t%-9s  %-40s\n" "0.1.6" "Single D tag -- run on D1_2420 MC sample(@707)"
    printf "\n\t%-9s  %-40s\n" "0.1.7" "Get samples -- extracte useful info: signal region, ISR factors"
    printf "\n\t%-9s  %-40s\n" "0.1.8" "Get samples -- apply cuts: D1_2420 MC"
...
case $option in
    ...
    0.1.3) echo "Simulation & Reconstruction -- generating D1_2420 MC sample(@707)..."
           cd scripts/mc/D1_2420_001000
    ...
    0.1.4) echo "Single D tag -- running on D1_2420 MC sample(@703p01)..."
           cd scripts/mc/D1_2420_001000
    ...
    0.1.5) echo "Single D tag -- running on D1_2420 MC sample(@705)..."
           cd scripts/mc/D1_2420_001000
    ...
    0.1.6) echo "Single D tag -- running on D1_2420 MC sample(@707)..."
           cd scripts/mc/D1_2420_001000
    ...
    0.1.7) echo "Get samples -- extracting useful info: signal region, ISR factors..."
           cd scripts/mc/D1_2420_001000
