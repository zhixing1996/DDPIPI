#!/bin/sh
PATCH=$1
mkdir -p /besfs5/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/fit_range
mkdir -p /besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/mixed/sys_err/fit_range
...
do
    ...
    cd $HOME/bes/DDPIPI/v0.2/python/sys_err/fit_range
    threshold=4316
