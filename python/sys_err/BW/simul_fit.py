...
def main():
    ...
    if ecms > 4316:
        ...
        path.append('/besfs5/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/BW/shape_side_'+str(ecms)+'.root')
        path.append('/besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/psipp/'+str(ecms)+'/sys_err/BW/sigMC_psipp_'+str(ecms)+'_after.root')
        path.append('/besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/'+str(ecms)+'/sys_err/BW/sigMC_D_D_PI_PI_'+str(ecms)+'_after.root')
        path.append('/besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/'+str(ecms)+'/sys_err/BW/sigMC_D1_2420_'+str(ecms)+'_after.root')
        fit(ecms, patch, path)
