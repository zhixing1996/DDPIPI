...
do
    ...
    rm -rf subSimRec_*.sh
    rm -rf xs_user.dat
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/BW/scripts/mc/psipp/jobOptions_sim_sig_psipp_PI_PI_VSS_tempE_703p01.sh ./jobOptions_sim_sig_psipp_PI_PI_VSS_$PARAM_0\.sh
    ...
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/BW/scripts/mc/psipp/jobOptions_rec_sig_psipp_PI_PI_VSS_tempE_703p01.sh ./jobOptions_rec_sig_psipp_PI_PI_VSS_$PARAM_0\.sh
