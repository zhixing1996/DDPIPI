...
DIR_NAME="/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/psipp/TEMP_0/sys_err/BW/rtraw/"
EVENT_NO=$3
...
do
    ...
    echo "EvtDecay.userDecayTableName = \"$HOME/bes/DDPIPI/v0.2/python/sys_err/BW/scripts/mc/psipp/psi4260_psipp_PI_PI_VSS.dec\";" >> $SIM_NAME
    echo "EvtDecay.PdtTableDir = \"$HOME/bes/DDPIPI/v0.2/python/sys_err/BW/scripts/mc/psipp/pdt_703p01.table\";" >> $SIM_NAME
