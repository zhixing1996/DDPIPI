...
do
    ...
    rm -rf subSimRec_*.sh
    rm -rf xs_user.dat
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/BW/scripts/mc/DDPIPI/jobOptions_sim_sig_D_D_PI_PI_tempE_707_KKMC.sh ./jobOptions_sim_sig_D_D_PI_PI_$PARAM_0\.sh
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/BW/scripts/mc/DDPIPI/xs_user.dat ./xs_user.dat
    ...
    rm -rf /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/sys_err/BW/rtraw/*.rtraw
    sh jobOptions_sim_sig_D_D_PI_PI_$PARAM_0\.sh 0 9 5000
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/BW/scripts/mc/DDPIPI/jobOptions_rec_sig_D_D_PI_PI_tempE_707.sh ./jobOptions_rec_sig_D_D_PI_PI_$PARAM_0\.sh
    sed -i "s/TEMP_0/$PARAM_0/g" jobOptions_rec_sig_D_D_PI_PI_$PARAM_0\.sh
    rm -rf /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/sys_err/BW/dst/*.dst
