...
DIR_NAME_RTRAW="/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/TEMP_0/sys_err/BW/rtraw/"
DIR_NAME_DST="/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/TEMP_0/sys_err/BW/dst/"
EVENT_NO=-1
