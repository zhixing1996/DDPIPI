...
do
    ...
    mkdir -p $WORKAREA/sigMC/psipp/$PARAM_0/sys_err/BW
    cd $HOME/bes/DDPIPI/v0.2/python/sys_err/BW
    rm -rf /besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0/sys_err/BW/*signal*.root
    rm -rf /besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0/sys_err/BW/*raw*.root
    ROOT_PATH=/besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0/sys_err/BW
    FILE_PATH=/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0/sys_err/BW/rootfile
