...
do
    ...
    cd /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/$PARAM_0/sys_err/BW/rootfile
    ...
    if [[ $PARAM_0 == *$shortbar1* ]]; then
        ...
        mkdir -p $dir
        mv /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/$PARAM_0/sys_err/BW/rootfile/sigMC_D1_2420_$PARAM_0\.root ./$dir
    fi
