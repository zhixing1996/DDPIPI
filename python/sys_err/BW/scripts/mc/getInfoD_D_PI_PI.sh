...
do
    ...
    rm -rf /besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/sys_err/BW/*signal*.root
    rm -rf /besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/sys_err/BW/*raw*.root
    ROOT_PATH=/besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/sys_err/BW
    FILE_PATH=/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/sys_err/BW/rootfile
    echo "Begining of $PARAM_0!"

    python get_info.py $FILE_PATH/sigMC_D_D_PI_PI_$PARAM_0\.root $ROOT_PATH/sigMC_D_D_PI_PI_$PARAM_0\_signal.root $PARAM_3 STDDmiss_signal
