...
do
    ...
    cd /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/sys_err/BW/rootfile
    ...
    if [[ $PARAM_0 == *$shortbar1* ]]; then
        ...
        mkdir -p $dir
        mv /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/DDPIPI/$PARAM_0/sys_err/BW/rootfile/sigMC_D_D_PI_PI_$PARAM_0\.root ./$dir
    fi
