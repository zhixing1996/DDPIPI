...
do
    ...
    rm -rf /besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0/sys_err/BW/*before*.root
    rm -rf /besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0/sys_err/BW/*after*.root
