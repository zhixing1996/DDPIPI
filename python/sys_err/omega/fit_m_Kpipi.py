...
def main():
    ...
    if mode == 'data':
        ...
        shape_path = '/besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/mixed/sys_err/omega/shape_' + str(ecms) + '_mixed_raw.root'
        fit(path, ecms, mode, shape_path, patch)
    if mode == 'MC':
        path.append('/besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/mixed/sys_err/omega/sigMC_mixed_width_' + str(ecms) + '_raw.root')
        shape_path = '/besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/mixed/sys_err/omega/shape_' + str(ecms) + '_mixed_raw.root'
        fit(path, ecms, mode, shape_path, patch)
