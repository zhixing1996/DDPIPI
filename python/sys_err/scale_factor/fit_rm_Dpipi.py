...
def main():
    ...
    if mode == 'psipp' or mode == 'D1_2420':
        ...
        shape_path = '/besfs/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/scale_factor/shape_' + mode + '_' + str(ecms) + '_signal.root'
    if mode == 'DDPIPI':
        path.append('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/' + mode + '/' + str(ecms) + '/sigMC_D_D_PI_PI_' + str(ecms) + '_raw_before.root')
        shape_path = '/besfs/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/scale_factor/shape_D_D_PI_PI_' + str(ecms) + '_signal.root'
