...
do
    ...
    cd jobs_sig
    mkdir -p /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/$PARAM_0/sys_err/D1_2420_shape/rtraw
    mkdir -p /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/$PARAM_0/sys_err/D1_2420_shape/dst
    rm -rf jobOptions*txt
    rm -rf subSimRec_*.sh
    rm -rf xs_user.dat
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/D1_2420_shape/scripts/mc/D1_2420/jobOptions_sim_sig_D1_2420_D_tempE_707.sh ./jobOptions_sim_sig_D1_2420_D_$PARAM_0\.sh
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/D1_2420_shape/scripts/mc/D1_2420/xs_user.dat ./xs_user.dat
    ...
    rm -rf /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/$PARAM_0/sys_err/D1_2420_shape/rtraw/*.rtraw
    sh jobOptions_sim_sig_D1_2420_D_$PARAM_0\.sh 0 9 5000
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/D1_2420_shape/scripts/mc/D1_2420/jobOptions_rec_sig_D1_2420_D_tempE_707.sh ./jobOptions_rec_sig_D1_2420_D_$PARAM_0\.sh
    sed -i "s/TEMP_0/$PARAM_0/g" jobOptions_rec_sig_D1_2420_D_$PARAM_0\.sh
    rm -rf /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/$PARAM_0/sys_err/D1_2420_shape/dst/*.dst
    sh jobOptions_rec_sig_D1_2420_D_$PARAM_0\.sh 0 9
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/D1_2420_shape/scripts/mc/D1_2420/subSimRec.sh ./
    sh subSimRec.sh jobOptions_sim_sig_D1_2420_D_$PARAM_0 jobOptions_rec_sig_D1_2420_D_$PARAM_0 subSimRec_D1_2420_$PARAM_0\_707 0 9
done
