...
def main():
    ...
    path.append('/besfs5/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/D1_2420_shape/shape_side_'+str(ecms)+'.root')
    ...
    path.append('/besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/D1_2420/'+str(ecms)+'/sys_err/D1_2420_shape/sigMC_D1_2420_'+str(ecms)+'_after.root')
    fit(ecms, patch, path)
