...
do
    ...
    cd jobs_sig
    mkdir -p /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0/sys_err/psipp_shape/rtraw
    mkdir -p /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0/sys_err/psipp_shape/dst
    rm -rf jobOptions*txt
    rm -rf subSimRec_*.sh
    rm -rf xs_user.dat
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/psipp_shape/scripts/mc/psipp/jobOptions_sim_sig_psipp_PI_PI_VSS_tempE_703p01.sh ./jobOptions_sim_sig_psipp_PI_PI_VSS_$PARAM_0\.sh
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/psipp_shape/scripts/mc/psipp/xs_user.dat ./xs_user.dat
    ...
    rm -rf /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0/sys_err/psipp_shape/rtraw/*.rtraw
    sh jobOptions_sim_sig_psipp_PI_PI_VSS_$PARAM_0\.sh 0 9 5000
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/psipp_shape/scripts/mc/psipp/jobOptions_rec_sig_psipp_PI_PI_VSS_tempE_703p01.sh ./jobOptions_rec_sig_psipp_PI_PI_VSS_$PARAM_0\.sh
    sed -i "s/TEMP_0/$PARAM_0/g" jobOptions_rec_sig_psipp_PI_PI_VSS_$PARAM_0\.sh
    rm -rf /scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/psipp/$PARAM_0/sys_err/psipp_shape/dst/*.dst
    sh jobOptions_rec_sig_psipp_PI_PI_VSS_$PARAM_0\.sh 0 9
    cp -rf $HOME/bes/DDPIPI/v0.2/python/sys_err/psipp_shape/scripts/mc/psipp/subSimRec.sh ./
    sh subSimRec.sh jobOptions_sim_sig_psipp_PI_PI_VSS_$PARAM_0 jobOptions_rec_sig_psipp_PI_PI_VSS_$PARAM_0 subSimRec_psipp_$PARAM_0\_703p01 0 9
done
