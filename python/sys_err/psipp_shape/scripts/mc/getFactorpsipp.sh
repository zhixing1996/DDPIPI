...
do
    ...
    WORKAREA=/scratchfs/bes/$USER/bes/DDPIPI/v0.2/run/gen_mc/sigMC/psipp/$PARAM_0/sys_err/psipp_shape/jobs_sig/jobs.out
    SCPTPATH=$HOME/bes/DDPIPI/v0.2/python/sys_err/psipp_shape
    shortbar1="-1"
    shortbar2="-2"
