...
def main():
    ...
    if ecms > 4316:
        ...
        path.append('/besfs5/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/psipp_shape/shape_side_'+str(ecms)+'.root')
        path.append('/besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/psipp/'+str(ecms)+'/sys_err/psipp_shape/sigMC_psipp_'+str(ecms)+'_after.root')
