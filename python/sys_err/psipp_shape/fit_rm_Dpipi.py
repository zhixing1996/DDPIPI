...
def main():
    ...
    if mode == 'psipp':
        path.append('/besfs/users/$USER/bes/DDPIPI/v0.2/sigMC/' + mode + '/' + str(ecms) + '/sys_err/psipp_shape/sigMC_' + mode + '_' + str(ecms) + '_raw_before.root')
        shape_path = '/besfs/users/$USER/bes/DDPIPI/v0.2/ana/shape/sys_err/psipp_shape/shape_' + mode + '_' + str(ecms) + '_signal.root'
