...
def main(mode):
    ...
    if mode == 'total':
        grerr_0_to_1.GetYaxis().SetRangeUser(-1.5, 0.7)
        grerr_0_to_1.Draw('ALP')
        # grerr_1_to_2.Draw('LP')
        # grerr_2_to_3.Draw('LP')
        # grerr_3_to_4.Draw('LP')
    if mode == 'D1_2420':
        grerr_0_to_1.GetYaxis().SetRangeUser(-3.0, 1.0)
        grerr_0_to_1.Draw('ALP')
        # grerr_1_to_2.Draw('LP')
        # grerr_2_to_3.Draw('LP')
        # grerr_3_to_4.Draw('LP')
    if mode == 'psipp':
        grerr_0_to_1.GetYaxis().SetRangeUser(-2.5, 1.3)
        grerr_0_to_1.Draw('ALP')
        # grerr_1_to_2.Draw('LP')
        # grerr_2_to_3.Draw('LP')
        # grerr_3_to_4.Draw('LP')
    if mode == 'DDPIPI':
        grerr_0_to_1.GetYaxis().SetRangeUser(-4.0, 1.2)
        grerr_0_to_1.Draw('ALP')
        # grerr_1_to_2.Draw('LP')
        # grerr_2_to_3.Draw('LP')
        # grerr_3_to_4.Draw('LP')
