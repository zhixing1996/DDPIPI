...
def plot(path, leg_title, ecms, xmin, xmax, xbins, ymin, ymax, ybins, sample, num_charm):
    ...
    if sample == 'data':
        ...
        h_data.Draw('COLZ')
    if sample == 'sideband':
        h_side1 = TH2F('scatter_side1', 'scatter plot of N(othertrks) and N(othershws)', xbins, xmin, xmax, ybins, ymin, ymax)
        set_histo_style(h_side1, xtitle, ytitle)
        fill(t_side1, h_side1, num_charm)
        h_side2 = TH2F('scatter_side2', 'scatter plot of N(othertrks) and N(othershws)', xbins, xmin, xmax, ybins, ymin, ymax)
        set_histo_style(h_side2, xtitle, ytitle)
        fill(t_side2, h_side2, num_charm)
        h_side3 = TH2F('scatter_side3', 'scatter plot of N(othertrks) and N(othershws)', xbins, xmin, xmax, ybins, ymin, ymax)
        set_histo_style(h_side3, xtitle, ytitle)
        fill(t_side3, h_side3, num_charm)
        h_side4 = TH2F('scatter_side4', 'scatter plot of N(othertrks) and N(othershws)', xbins, xmin, xmax, ybins, ymin, ymax)
