#!/usr/bin/env python
"""
Plot energy of other showers
"""

__author__ = "Maoqiang JING <jingmq@ihep.ac.cn>"
__copyright__ = "Copyright (c) Maoqiang JING"
__created__ = "[2020-10-18 Sun 19:31]"
...
SYNOPSIS
    ./plot_E_othershws.py [ecms] [num_charm]
...
def E_othershowers_fill(t, h, num_charm):
    for ientry in xrange(t.GetEntries()):
        t.GetEntry(ientry)
        if t.m_n_p == 0 and t.m_n_pbar == 0 and t.m_charm == num_charm:
            h.Fill(t.m_E_othershws)
...
def plot(path, ecms, xmin, xmax, num_charm):
    ...
    mbc.SaveAs('./figs/E_othershws_'+str(ecms)+'_'+str(num_charm)+'.pdf')
