#!/usr/bin/env python
"""
Plot number of K plus
"""

__author__ = "Maoqiang JING <jingmq@ihep.ac.cn>"
__copyright__ = "Copyright (c) Maoqiang JING"
__created__ = "[2020-10-18 Sun 20:52]"
...
def plot(path, ecms, xmin, xmax, num_charm):
    ...
    mbc.SaveAs('./figs/n_Kp_'+str(ecms)+'_'+str(num_charm)+'.pdf')
