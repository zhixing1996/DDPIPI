#!/usr/bin/env python
"""
Plot momentum of other showers
"""

__author__ = "Maoqiang JING <jingmq@ihep.ac.cn>"
__copyright__ = "Copyright (c) Maoqiang JING"
__created__ = "[2020-10-18 Sun 21:12]"
...
SYNOPSIS
    ./plot_p_othershws.py [ecms] [num_charm]
...
def plot(path, ecms, xmin, xmax, num_charm):
    ...
    mbc.SaveAs('./figs/p_othershws_'+str(ecms)+'_'+str(num_charm)+'.pdf')
