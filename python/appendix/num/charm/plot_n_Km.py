#!/usr/bin/env python
"""
Plot number of K minus
"""

__author__ = "Maoqiang JING <jingmq@ihep.ac.cn>"
__copyright__ = "Copyright (c) Maoqiang JING"
__created__ = "[2020-10-18 Sun 20:07]"
...
def n_Km_fill(t, h, num_charm):
    for ientry in xrange(t.GetEntries()):
        t.GetEntry(ientry)
        if t.m_charm == num_charm and t.m_n_p == 0 and t.m_n_pbar == 0:
            h.Fill(t.m_n_Km)
...
def plot(path, ecms, xmin, xmax, num_charm):
    ...
    mbc.SaveAs('./figs/n_Km_'+str(ecms)+'_'+str(num_charm)+'.pdf')
