#!/usr/bin/env python
"""
Plot momentum of missed D
"""

__author__ = "Maoqiang JING <jingmq@ihep.ac.cn>"
__copyright__ = "Copyright (c) Maoqiang JING"
__created__ = "[2020-10-18 Sun 21:03]"
...
SYNOPSIS
    ./plot_p_Dmiss.py [ecms] [num_charm]
...
def p_Dmiss_fill(t, h, num_charm):
...
def plot(path, ecms, xmin, xmax, num_charm):
    ...
    mbc.SaveAs('./figs/p_Dmiss_'+str(ecms)+'_'+str(num_charm)+'.pdf')
...
if __name__ == '__main__':
    ...
    path.append('/besfs5/users/$USER/bes/DDPIPI/v0.2/data/'+str(ecms)+'/data_'+str(ecms)+'_sideband_after.root')
    xmin = 0
    xmax = 2
