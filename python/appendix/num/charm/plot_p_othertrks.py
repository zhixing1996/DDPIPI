#!/usr/bin/env python
"""
Plot momentum of other tracks
"""

__author__ = "Maoqiang JING <jingmq@ihep.ac.cn>"
__copyright__ = "Copyright (c) Maoqiang JING"
__created__ = "[2020-10-18 Sun 21:22]"
...
SYNOPSIS
    ./plot_P_othertrks.py [ecms] [num_charm]
...
def plot(path, ecms, xmin, xmax, num_charm):
    ...
    p_othertrks_fill(t_sideband, h_sideband, num_charm)
