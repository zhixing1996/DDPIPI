#!/usr/bin/env python
"""
Plot momentum of other tracks and showers
"""

__author__ = "Maoqiang JING <jingmq@ihep.ac.cn>"
__copyright__ = "Copyright (c) Maoqiang JING"
__created__ = "[2020-10-18 Sun 19:06]"
...
def usage():
    sys.stdout.write('''
NAME
    plot_p_othertrksshws.py

SYNOPSIS
    ./plot_p_othertrksshws.py [ecms] [num_charm]
...
def p_othertrksshws_fill(t, h, num_charm):
    for ientry in xrange(t.GetEntries()):
        t.GetEntry(ientry)
        if t.m_n_p == 0 and t.m_n_pbar == 0 and t.m_charm == num_charm:
            h.Fill(t.m_p_otherall)
...
def plot(path, ecms, xmin, xmax, num_charm):
    ...
    mbc.SaveAs('./figs/p_othertrksshws_'+str(ecms)+'_'+str(num_charm)+'.pdf')
