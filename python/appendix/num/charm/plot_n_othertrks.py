#!/usr/bin/env python
"""
Plot number of other tracks
"""

__author__ = "Maoqiang JING <jingmq@ihep.ac.cn>"
__copyright__ = "Copyright (c) Maoqiang JING"
__created__ = "[2020-10-18 Sun 19:16]"
...
SYNOPSIS
    ./plot_n_othertrks.py [ecms] [num_charm]
...
def plot(path, ecms, xmin, xmax, num_charm):
    ...
    mbc.SaveAs('./figs/n_othertrks_'+str(ecms)+'_'+str(num_charm)+'.pdf')
