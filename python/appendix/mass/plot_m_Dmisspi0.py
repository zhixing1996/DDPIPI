#!/usr/bin/env python
"""
Plot invariant mass of tagged D and tagged pi0
"""
...
def m_Dmisspi0_fill(t, h):
    for ientry in xrange(t.GetEntries()):
        ...
        if not discarded: h.Fill(t.m_m_Dmisspi0)
...
def plot(path, leg_title, ecms):
    ...
    mbc.SaveAs('./figs/m_Dmisspi0_'+str(ecms)+'.pdf')
