#!/usr/bin/env python
"""
Plot recoiling mass of tagged D and tagged pi0
"""
...
def rm_Dpi0_fill(t, h):
    for ientry in xrange(t.GetEntries()):
        ...
        if not discarded: h.Fill(t.m_rm_Dpi0)
...
def plot(path, leg_title, ecms):
    ...
    mbc.SaveAs('./figs/rm_Dpi0_'+str(ecms)+'.pdf')
