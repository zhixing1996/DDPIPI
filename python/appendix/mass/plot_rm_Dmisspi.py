#!/usr/bin/env python
"""
Plot recoiling mass of missed D and selected piplus
"""
...
def rm_Dmisspi_fill(t, h):
    for ientry in xrange(t.GetEntries()):
        ...
        if not discarded: h.Fill(t.m_rm_Dmisspi)
...
def plot(path, leg_title, ecms):
    ...
    mbc.SaveAs('./figs/rm_Dmisspi_'+str(ecms)+'.pdf')
