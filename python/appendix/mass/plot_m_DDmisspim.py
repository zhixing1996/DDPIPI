#!/usr/bin/env python
"""
Plot invariant mass of tagged D missed D and selected piminus
"""
...
def m_DDmisspim_fill(t, h):
    for ientry in xrange(t.GetEntries()):
        ...
        if not discarded: h.Fill(t.m_m_DDmisspim)
...
def plot(path, leg_title, ecms):
    ...
    mbc.SaveAs('./figs/m_DDmisspim_'+str(ecms)+'.pdf')
