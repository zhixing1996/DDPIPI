#!/usr/bin/env python
"""
Plot recoiling mass of missed D and tagged pi0
"""

__author__ = "Maoqiang JING <jingmq@ihep.ac.cn>"
__copyright__ = "Copyright (c) Maoqiang JING"
__created__ = "[2020-10-21 Thr 17:15]"
...
def rm_Dmisspi0_fill(t, h):
    for ientry in xrange(t.GetEntries()):
        ...
        if not discarded: h.Fill(t.m_rm_Dmisspi0)
...
def plot(path, leg_title, ecms):
    ...
    mbc.SaveAs('./figs/rm_Dmisspi0_'+str(ecms)+'.pdf')
