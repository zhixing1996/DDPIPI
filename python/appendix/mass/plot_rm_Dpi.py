#!/usr/bin/env python
"""
Plot recoiling mass of tagged D and selected piminus
"""
...
def rm_Dpi_fill(t, h):
    for ientry in xrange(t.GetEntries()):
        ...
        if not discarded: h.Fill(t.m_rm_Dpi)
...
def plot(path, leg_title, ecms):
    ...
    mbc.SaveAs('./figs/rm_Dpi_'+str(ecms)+'.pdf')
