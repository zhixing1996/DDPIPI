#!/usr/bin/env python
"""
Plot invariant mass of missed D and selected piplus
"""
...
def m_Dmisspi_fill(t, h):
    for ientry in xrange(t.GetEntries()):
        ...
        if not discarded: h.Fill(t.m_m_Dmisspi)
...
def plot(path, leg_title, ecms):
    ...
    mbc.SaveAs('./figs/m_Dmisspi_'+str(ecms)+'.pdf')
