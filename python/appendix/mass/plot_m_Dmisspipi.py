#!/usr/bin/env python
"""
Plot invariant mass of missed D and selected piplus and piminus
"""
...
def m_Dmisspipi_fill(t, h):
    for ientry in xrange(t.GetEntries()):
        ...
        if not discarded: h.Fill(t.m_m_Dmisspipi)
