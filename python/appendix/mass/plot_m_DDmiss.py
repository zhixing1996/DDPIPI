#!/usr/bin/env python
"""
Plot invariant mass of tagged D and missed D
"""
...
def m_DDmiss_fill(t, h):
    for ientry in xrange(t.GetEntries()):
        ...
        if not discarded: h.Fill(t.m_m_DDmiss)
...
def plot(path, leg_title, ecms):
    ...
    mbc.SaveAs('./figs/m_DDmiss_'+str(ecms)+'.pdf')
