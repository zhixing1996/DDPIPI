#!/usr/bin/env python
"""
Plot invariant mass of tagged D and selected piplus and piminus
"""
...
def m_Dpipi_fill(t, h):
    for ientry in xrange(t.GetEntries()):
        ...
        if not discarded: h.Fill(t.m_m_Dpipi)
...
def plot(path, leg_title, ecms):
    ...
    legend = TLegend(0.2, 0.7, 0.3, 0.85)
