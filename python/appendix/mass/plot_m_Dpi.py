#!/usr/bin/env python
"""
Plot invariant mass of tagged D and selected piminus
"""
...
def m_Dpi_fill(t, h):
    for ientry in xrange(t.GetEntries()):
        ...
        if not discarded: h.Fill(t.m_m_Dpi)
...
def plot(path, leg_title, ecms):
    ...
    mbc.SaveAs('./figs/m_Dpi_'+str(ecms)+'.pdf')
