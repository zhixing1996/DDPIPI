#!/usr/bin/env python
"""
Plot match invariant mass of pipi
"""

__author__ = "Maoqiang JING <jingmq@ihep.ac.cn>"
__copyright__ = "Copyright (c) Maoqiang JING"
__created__ = "[2019-10-14 Mon 22:03]"
...
def chi2_KF_fill(t, entries, h1, h2, h3, h4):
    for ientry in xrange(entries):
        t.GetEntry(ientry)
        if (t.m_n_pi0 == 0 or (t.m_n_pi0 != 0 and t.m_m_Dpi0 > 2.01)) and (t.m_m_D0 < 1.8 or t.m_m_D0 > 2.1) and t.m_chi2_kf < 20:
...
def plot(incMC_path, leg_title, ecms):
    try:
    ...
    legend = TLegend(0.55, 0.65, 0.84, 0.8)
