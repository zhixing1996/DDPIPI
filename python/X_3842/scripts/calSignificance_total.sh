#!/bin/sh
PATCH=$1
rm -rf $HOME/bes/DDPIPI/v0.2/python/X_3842/txts/significance*.txt
...
do
    ...
    python fit_rm_pipi.py $PARAM_0 data $PATCH
    python fit_rm_pipi.py $PARAM_0 none_sig $PATCH
    python significance.py $PARAM_0
