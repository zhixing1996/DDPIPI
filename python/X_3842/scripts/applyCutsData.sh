...
do
    ...
    rm -rf /besfs5/users/$USER/bes/DDPIPI/v0.2/data/$PARAM_0/*X_3842*.root
    ROOT_PATH=/besfs5/users/$USER/bes/DDPIPI/v0.2/data/$PARAM_0
    SOURCE_PATH=/besfs5/users/$USER/bes/DDPIPI/v0.2/data/$PARAM_0
    echo "Begininning of $PARAM_0!"

    python apply_cuts.py $SOURCE_PATH/data_$PARAM_0\_after.root $ROOT_PATH/data_$PARAM_0\_X_3842.root
