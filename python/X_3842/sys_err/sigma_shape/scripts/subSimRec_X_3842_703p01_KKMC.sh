...
do
    ...
    rm -rf subSimRec_*.sh
    rm -rf xs_user.dat
    cp -rf $HOME/bes/DDPIPI/v0.2/python/X_3842/sys_err/sigma_shape/jobOptions_sim_sig_Sigma_X_3842_tempE_703p01_KKMC.sh ./jobOptions_sim_sig_Sigma_X_3842_$PARAM_0\.sh
    ...
    cp -rf $HOME/bes/DDPIPI/v0.2/python/X_3842/sys_err/sigma_shape/jobOptions_rec_sig_Sigma_X_3842_tempE_703p01.sh ./jobOptions_rec_sig_Sigma_X_3842_$PARAM_0\.sh
