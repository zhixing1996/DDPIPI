...
do
    ...
    WORKAREA=/scratchfs/bes/$USER/bes/DDPIPI/v0.2/run/gen_mc/sigMC/X_3842/$PARAM_0/sys_err/sigma_shape/jobs_sig/jobs.out
    SCPTPATH=$HOME/bes/DDPIPI/v0.2/python/X_3842/sys_err/sigma_shape
    shortbar1="-1"
    shortbar2="-2"
