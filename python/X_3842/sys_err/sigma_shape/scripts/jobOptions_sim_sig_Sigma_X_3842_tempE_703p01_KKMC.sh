...
DIR_NAME="/scratchfs/bes/$USER/bes/DDPIPI/v0.2/sigMC/X_3842/TEMP_0/sys_err/sigma_shape/rtraw/"
EVENT_NO=$3

echo "./jobOptions_sim_sig_Sigma_X_3842_TEMP_0.sh [NUM1] [NUM2] [NUM3]"
...
JOB_NAME="jobOptions_sim_sig_Sigma_X_3842"
FILE_NAME="Sig_Sigma_X_3842"
...
do
    ...
    echo "EvtDecay.userDecayTableName = \"$HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/decay/psi4260_Sigma_X_3842.dec\";" >> $SIM_NAME
    echo "EvtDecay.PdtTableDir = \"$HOME/bes/DDPIPI/v0.2/python/X_3842/sys_err/sigma_shape/pdt_703p01.table\";" >> $SIM_NAME
