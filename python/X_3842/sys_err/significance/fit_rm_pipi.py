...
def fit(path, shape_path, ecms, mode, patch):
    ...
    f_param = open('../../txts/param_4680_' + patch + '.txt', 'r')
    ...
    if mode != 'background_shape': bkgpdf = RooChebychev('bkgpdf', 'bkgpdf', rm_pipi, RooArgList(a, b))
    else: bkgpdf = RooChebychev('bkgpdf', 'bkgpdf', rm_pipi, RooArgList(a))
    ...
    path_out = './txts/significance_likelihood_' + str(ecms) + '_' + mode + '.txt'
...
def main():
    ...
    if mode != 'sigma_shape': shape_path = '/besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/X_3842/sigMC_X_3842.root'
    else: shape_path = '/besfs5/users/$USER/bes/DDPIPI/v0.2/sigMC/X_3842/sys_err/sigma_shape/sigMC_X_3842.root'
