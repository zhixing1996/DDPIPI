...
usage() {
    ...
    printf "\n\t%-9s  %-40s\n" "0.4"   "[run on inclusive MC @4360MeV]"
    printf "\n\t%-9s  %-40s\n" "0.4.1" "Single D tag -- inclusive MC sample"

    printf "\n\t%-9s  %-40s\n" "0.5"   "[run on inclusive MC @4420MeV]"
    printf "\n\t%-9s  %-40s\n" "0.5.1" "Single D tag -- inclusive MC sample"

    printf "\n\t%-9s  %-40s\n" "0.6"   "[run on inclusive MC @4600MeV]"
    printf "\n\t%-9s  %-40s\n" "0.6.1" "Single D tag -- inclusive MC sample"

    printf "\n\t%-9s  %-40s\n" "0.7"   "[run on data @4360MeV]"
    printf "\n\t%-9s  %-40s\n" "0.7.1" "Single D tag -- data sample"

    printf "\n\t%-9s  %-40s\n" "0.8"   "[run on data @4420MeV]"
    printf "\n\t%-9s  %-40s\n" "0.8.1" "Single D tag -- data sample"

    printf "\n\t%-9s  %-40s\n" "0.9"   "[run on data @4600MeV]"
    printf "\n\t%-9s  %-40s\n" "0.9.1" "Single D tag -- data sample"
...
case $option in
    ...
    0.7.1) echo "Single D tag -- run on data sample..."
    ...
    0.8.1) echo "Single D tag -- run on data sample..."
    ...
    0.9.1) echo "Single D tag -- run on data sample..."
