...
usage() {
    ...
    printf "\n\t%-9s  %-40s\n" "0.4"   "[run on inclusive MC (DDbar) @4360MeV]"
    printf "\n\t%-9s  %-40s\n" "0.4.1" "Single D tag -- inclusive MC sample"

    printf "\n\t%-9s  %-40s\n" "0.5"   "[run on inclusive MC (DDbar) @4420MeV]"
    printf "\n\t%-9s  %-40s\n" "0.5.1" "Single D tag -- inclusive MC sample"

    printf "\n\t%-9s  %-40s\n" "0.6"   "[run on inclusive MC (DDbar) @4600MeV]"
    printf "\n\t%-9s  %-40s\n" "0.6.1" "Single D tag -- inclusive MC sample"

    printf "\n\t%-9s  %-40s\n" "0.7"   "[run on inclusive MC (qqbar) @4360MeV]"
    printf "\n\t%-9s  %-40s\n" "0.7.1" "Single D tag -- inclusive MC sample"

    printf "\n\t%-9s  %-40s\n" "0.8"   "[run on inclusive MC (qqbar) @4420MeV]"
    printf "\n\t%-9s  %-40s\n" "0.8.1" "Single D tag -- inclusive MC sample"

    printf "\n\t%-9s  %-40s\n" "0.9"   "[run on inclusive MC (qqbar) @4600MeV]"
    printf "\n\t%-9s  %-40s\n" "0.9.1" "Single D tag -- inclusive MC sample"

    printf "\n\t%-9s  %-40s\n" "0.10"   "[run on inclusive MC (LLbar) @4600MeV]"
    printf "\n\t%-9s  %-40s\n" "0.10.1" "Single D tag -- inclusive MC sample"

    printf "\n\t%-9s  %-40s\n" "0.11"   "[run on data @4360MeV]"
    printf "\n\t%-9s  %-40s\n" "0.11.1" "Single D tag -- data sample"

    printf "\n\t%-9s  %-40s\n" "0.12"   "[run on data @4420MeV]"
    printf "\n\t%-9s  %-40s\n" "0.12.1" "Single D tag -- data sample"

    printf "\n\t%-9s  %-40s\n" "0.13"   "[run on data @4600MeV]"
...
case $option in
    ...
    0.4) echo "inclusive MC @4360MeV..."
         echo "--> E_{CMS}: 4358.260MeV"
         echo "--> Mode: DDbar"
         echo "--> Energy Spread: 1.97MeV"
         ;;

    0.4.1) echo "Single D tag -- run on inclusive MC sample..."
           ...
           cp -rf $HOME/bes/DDPIPI/v0.2/python/make_mc.py ./
           cp -rf $HOME/bes/DDPIPI/v0.2/python/tools.py ./
           ./make_mc.py /besfs/groups/psip/psipgroup/664p01-MC/4360/res/DD incMC inclusive DD DD 4360 20
           cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/subAna.sh ./
           rm -rf *boss*
    ...
    0.5) echo "inclusive MC @4420MeV..."
         echo "--> E_{CMS}: 4415.580MeV"
         echo "--> Mode: DDbar"
         echo "--> Energy Spread: 2.03MeV"
         ;;

    0.5.1) echo "Single D tag -- run on inclusive MC sample..."
           ...
           cp -rf $HOME/bes/DDPIPI/v0.2/python/make_mc.py ./
           cp -rf $HOME/bes/DDPIPI/v0.2/python/tools.py ./
           ./make_mc.py /besfs/groups/psip/psipgroup/664p01-MC/4420/DD incMC inclusive DD DD 4420 20
           cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/subAna.sh ./
           rm -rf *boss*
    ...
    0.6.1) echo "Single D tag -- run on inclusive MC sample..."
           ...
           cp -rf $HOME/bes/DDPIPI/v0.2/python/make_mc.py ./
           cp -rf $HOME/bes/DDPIPI/v0.2/python/tools.py ./
           ./make_mc.py /besfs/groups/psip/psipgroup/664p01-MC/4600/DD incMC inclusive DD DD 4600 20
           cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/subAna.sh ./
           rm -rf *boss*
    ...
    0.7.1) echo "Single D tag -- run on inclusive MC sample..."
           ...
           cp -rf $HOME/bes/DDPIPI/v0.2/python/make_mc.py ./
           cp -rf $HOME/bes/DDPIPI/v0.2/python/tools.py ./
           ./make_mc.py /besfs/groups/psip/psipgroup/664p01-MC/4360/QED/qqbar incMC inclusive qq qq 4360 20
           cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/subAna.sh ./
           rm -rf *boss*
    ...
    0.8.1) echo "Single D tag -- run on inclusive MC sample..."
           ...
           cp -rf $HOME/bes/DDPIPI/v0.2/python/make_mc.py ./
           cp -rf $HOME/bes/DDPIPI/v0.2/python/tools.py ./
           ./make_mc.py /besfs/groups/psip/psipgroup/664p01-MC/4420/qqbar incMC inclusive qq qq 4420 20
           cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/subAna.sh ./
           rm -rf *boss*
    ...
    0.9.1) echo "Single D tag -- run on inclusive MC sample..."
           ...
           cp -rf $HOME/bes/DDPIPI/v0.2/python/make_mc.py ./
           cp -rf $HOME/bes/DDPIPI/v0.2/python/tools.py ./
           ./make_mc.py /besfs/groups/psip/psipgroup/664p01-MC/4600/qqbar incMC inclusive qq qq 4600 20
           cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/subAna.sh ./
           rm -rf *boss*
    ...
    0.10) echo "inclusive MC @4600MeV..."
          echo "--> E_{CMS}: 4599.530MeV"
          echo "--> Mode: LLbar"
          echo "--> Energy Spread: 2.20MeV"
          ;;
    ...
    0.10.1) echo "Single D tag -- run on inclusive MC sample..."
            ...
            cp -rf $HOME/bes/DDPIPI/v0.2/python/make_mc.py ./
            cp -rf $HOME/bes/DDPIPI/v0.2/python/tools.py ./
            ./make_mc.py /besfs/groups/psip/psipgroup/664p01-MC/4600/LL incMC inclusive LL LL 4600 20
            cp -rf $HOME/bes/DDPIPI/v0.2/scripts/gen_script/gen_mc/subAna.sh ./
            rm -rf *boss*
