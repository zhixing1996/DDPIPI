...
void fit_mDst_4420() {
    ...
    RooDataSet* data = new RooDataSet("data", "dataset", t, mDst);

    // signal
    RooRealVar mean1("mean1", "mean of gaussian", 2.01026, 2.008, 2.013);
    RooRealVar sigma1("sigma1", "width of gaussian", 0.001, 0, 0.008);
    RooGaussian gauss1("gauss1", "gauss", mDst, mean1, sigma1);
    RooRealVar mean2("mean2", "mean of gaussian", 2.01026, 2.008, 2.013);
    RooRealVar sigma2("sigma2", "width of gaussian", 0.001, 0, 0.02);
    RooGaussian gauss2("gauss2", "gauss", mDst, mean2, sigma2);
    ...
    // RooPolynomial bkgpdf("bkgpdf", "bkgpdf", mDst, RooArgSet(a, b, c, d));
    RooPolynomial bkgpdf("bkgpdf", "bkgpdf", mDst, RooArgSet(a, b));
