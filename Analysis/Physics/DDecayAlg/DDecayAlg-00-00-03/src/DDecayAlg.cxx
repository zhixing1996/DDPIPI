...
StatusCode DDecay::initialize() {
    ...
    if (nt3) m_tuple3 = nt3;
        ...
        if (m_tuple3) {
            ...
            status = m_tuple3->addIndexedItem("motherid", m_idxmc_Truth, m_motherid_Truth);
...
void DDecay::saveAllMcTruthInfo() {
    ...
    // // const int incPid=9020443; // 9020443 is the PDG code of psi(4415)
