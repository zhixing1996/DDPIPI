...
${CMTROOT}/mgr/cmt setup -csh -pack=DDecayAlg -version=DDecayAlg-00-00-01 -path=/afs/ihep.ac.cn/users/j/jingmq/bes/DDPIPI/v0.2/Analysis/Physics  -no_cleanup $* >${tempfile}; source ${tempfile}
/bin/rm -f ${tempfile}
